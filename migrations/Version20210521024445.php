 ...
 */
final class Version20210521024445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, transport_id INT NOT NULL, depart VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, nbparticipant INT NOT NULL, dateevenement DATE NOT NULL, duree INT NOT NULL, prix DOUBLE PRECISION NOT NULL, programme VARCHAR(255) NOT NULL, contact VARCHAR(255) NOT NULL, infos VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, circuit VARCHAR(255) DEFAULT NULL, nomevenement VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_B26681E9909C13F (transport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE evenements_sentiers (idrandonnee INT NOT NULL, idsentier INT NOT NULL, INDEX IDX_A9172222B56A006A (idrandonnee), INDEX IDX_A9172222E40958F5 (idsentier), PRIMARY KEY(idrandonnee, idsentier)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE forum (id INT AUTO_INCREMENT NOT NULL, user_cin INT DEFAULT NULL, sujet VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date DATE NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_852BBECD40F35151 (user_cin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, forum_id INT DEFAULT NULL, user_cin INT DEFAULT NULL, description VARCHAR(255) NOT NULL, date DATE NOT NULL, INDEX IDX_5FB6DEC729CCBAD0 (forum_id), INDEX IDX_5FB6DEC740F35151 (user_cin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transport (idtransport INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, volumemax INT NOT NULL, nombre_transports INT NOT NULL, PRIMARY KEY(idtransport)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (cin INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, age INT NOT NULL, sexe VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, tel INT NOT NULL, status VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(cin)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67D40F35151 FOREIGN KEY (user_cin) REFERENCES user (cin)');
        $this->addSql('ALTER TABLE evenement ADD CONSTRAINT FK_B26681E9909C13F FOREIGN KEY (transport_id) REFERENCES transport (idtransport)');
