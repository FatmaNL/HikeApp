 ...
 */
final class Version20210311132018 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sentier ADD no VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE transport ADD camping_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sentier DROP no');
        ...
        $this->addSql('ALTER TABLE transport DROP camping_id');
    }
}
